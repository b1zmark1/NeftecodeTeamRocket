...
DEFAULT_TRAIN = ROOT / "compact_v3" / "oxidation_enhancement" / "oxidation_focus_v2_train.csv"
DEFAULT_OUTDIR = ROOT / "compact_v3" / "oxidation_focus_v2_output"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train oxidation-only MLP on oxidation_focus_v2 dataset.")
    ...
    fold_path = args.outdir / "oxidation_focus_v2_cv_fold_metrics.csv"
    summary_path = args.outdir / "oxidation_focus_v2_cv_summary.csv"
    oof_path = args.outdir / "oxidation_focus_v2_oof_predictions.csv"
    model_path = args.outdir / "oxidation_focus_v2_best_model.joblib"
    manifest_path = args.outdir / "oxidation_focus_v2_run_manifest.json"
